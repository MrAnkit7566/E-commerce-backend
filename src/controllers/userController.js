...
let getUserProfile = async (req,res)=>{
  try {
    let userId = req.user.userId //getting userid from middleware
    let userProfile = await userModel.findById(userId)
     res.json({ "message": "User ID extracted successfully",
      "userId": userId ,
...
module.exports = { addUsers, getUsers, updateUser, deleteUser, loginUser ,getUserProfile};
